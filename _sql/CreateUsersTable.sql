...
--- 유저 테이블 생성
CREATE TABLE users (
    user_no NUMBER NOT NULL UNIQUE, -- 가입한 순서를 나타내는 자동 증가 필드
...
INSERT INTO users (user_no, user_id, user_pw, user_name) VALUES ( user_seq.NEXTVAL, 'test', '123', 'wbpark');
INSERT INTO users (user_no, user_id, user_pw, user_name) VALUES (user_seq.NEXTVAL, 'user1', 'password1', '철수');
INSERT INTO users (user_no, user_id, user_pw, user_name) VALUES (user_seq.NEXTVAL, 'user2', 'password2', '영희');
