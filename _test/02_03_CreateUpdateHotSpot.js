...
(async () => {
    ...
    console.log(`이미지 이동 : NewTop:${NewTop}, NewLeft:${NewLeft}`)
    const pdateHotspotPos = await db_mapUpdateHotspotPos(CreateHotspot.spotId,NewLeft,top);
    console.log(`이미지 이동 : ${pdateHotspotPos.succeed? "성공" : "실패"}`)
})()